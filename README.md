# JoCoding AX Hackathon 2026 — Codex Plugins

AX 인재전쟁 해커톤 예선 제출물. 참여 기업의 공개·검증 가능한 실무 문제를 푸는 OpenAI Codex 플러그인 4종을 하나의 마켓플레이스로 배포합니다.

> **본선 프로젝트:** 실패 상담을 사람 승인과 회귀시험으로 운영 지식에 반영하는 [SETTY — AI Handoff Copilot](https://github.com/chenjingdev-archive/jocoding-ax-hackathon-setty)
...
```bash
codex plugin marketplace add https://github.com/chenjingdev-archive/jocoding-ax-hackathon-plugins
