...
```bash
git clone https://github.com/chenjingdev/ax-hackathon-plugins.git
codex plugin marketplace add ./ax-hackathon-plugins
codex plugin install musinsa-listing-compliance      # 필요한 것만 골라 설치
codex plugin install myrealtrip-listing-factcheck
codex plugin install meditherapy-seeding-screener
```
