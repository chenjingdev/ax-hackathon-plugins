...
2. 채팅으로 안내: "Finder에 띄워드린 파일(제품 정보 + 후보 4인의 게시물·대본·댓글)을 이 채팅에 끌어다 놓고 **'스크리닝해줘'**라고 해주세요. 첨부하신 콘텐츠를 5차원으로 채점하고 인용을 검증해 랭킹합니다."
3. 사용자가 파일을 첨부하면 **seeding-screener** 스킬로 그 첨부를 입력 삼아 스크리닝한다.
