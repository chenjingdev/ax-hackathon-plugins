...
3. 시연 제안 한 줄: "레티놀 세럼 시딩 후보 4인 — **89만 글램 셀럽, 60만 하울 유튜버, 8.2만 리뷰 크리에이터, 8,600 더마 전문가** — 를 채점해 팔로워 1·2위가 바닥으로 내려가고 8,600 더마 전문가가 **1위(≈78)** 로 역전되는 스크리닝을 시연해볼까요?"
...
- 마지막에 위 3)과 동일한 시연 제안 한 줄(후보 이야기로, 파일명은 괄호 참고로만).
