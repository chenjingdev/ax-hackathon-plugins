...
description: 시딩 후보 스크리닝/인플루언서 선별/콘텐츠 적합도 채점/구매유발 판단/숏리스트/온톨로지 갱신 재스캔 요청이면 반드시 이 스킬 사용 — 후보 1인이든 배열이든. 공개 콘텐츠(게시물·영상 대본·댓글)와 제품 컨텍스트를 한국 동료심사 근거로 가중된 구매유발 온톨로지(5차원)로 정량·정성 스코어링하고, 근거를 원문 인용한 glass-box 랭킹 숏리스트·보완 제안·콘텐츠 브리프를 생성한다. 자사 콘텐츠 사전점검·신시장 후보 스크리닝 포함. (매출 귀인·바이럴 예측·진위감사 아님.)
---
